...
USER_COMMANDS: List[BotCommand] = [
    BotCommand(command="menu", description="Show main menu with all commands"),
...
async def set_telegram_commands(bot: Bot, admin_ids: List[int] = None):
    ...
    try:
        # First, delete old commands for all users in private chats
        ...
        # Now, set the new, correct list of commands
