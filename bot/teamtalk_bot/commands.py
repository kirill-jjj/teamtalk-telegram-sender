...
from bot.constants import (
    ...
    TT_SUBSCRIBE_DEEPLINK_TEXT, TT_SUBSCRIBE_ERROR,
    TT_UNSUBSCRIBE_DEEPLINK_TEXT, TT_UNSUBSCRIBE_ERROR,
    TT_ADMIN_CMD_NO_PERMISSION, TT_ADD_ADMIN_PROMPT_IDS, TT_ADD_ADMIN_SUCCESS,
    TT_ADD_ADMIN_ERROR_ALREADY_ADMIN, TT_ADD_ADMIN_ERROR_INVALID_ID, TT_ADMIN_ERRORS_HEADER,
    TT_ADMIN_NO_VALID_IDS, TT_ADMIN_ERROR_PROCESSING, TT_REMOVE_ADMIN_PROMPT_IDS,
    TT_REMOVE_ADMIN_SUCCESS, TT_REMOVE_ADMIN_ERROR_NOT_FOUND, TT_ADMIN_INFO_ERRORS_HEADER,
    TT_NOON_USAGE, TT_NOON_CONFIRM_DEEPLINK_TEXT, TT_NOON_ERROR_PROCESSING,
    HELP_TEXT, TT_UNKNOWN_COMMAND_TT # Specific unknown command for TT
)
