...
class UserSettings(SQLModel, table=True):
    ...
    language: Language = Field(default=Language.ENGLISH, nullable=False) # <--- ИЗМЕНЕНО
    notification_settings: NotificationSetting = Field(default=NotificationSetting.ALL, nullable=False)
    mute_list_mode: "MuteListMode" = Field(default=MuteListMode.blacklist, nullable=False) # Ensure this uses Enum member
